...
const CloudflareContext = createContextSingleton(
  "CloudflareContext",
  {}
);
...
const DatabaseContext = createContextSingleton("DatabaseContext", null);
...
const EnvironmentContext = createContextSingleton("EnvironmentContext", "development");
