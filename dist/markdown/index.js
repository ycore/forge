...
var require_use_sync_external_store_shim_production = __commonJS((exports) => {
  ...
  var useState13 = React36.useState;
  var useEffect18 = React36.useEffect;
...
import { createContext as createContext7, useState as useState29 } from "react";
...
function createSlot(ownerName) {
  ...
  const Slot2 = React3.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx4(SlotClone, { ...slotProps, ref: forwardedRef, children: React3.isValidElement(newElement) ? React3.cloneElement(newElement, undefined, newChildren) : null });
    }
...
var VisuallyHidden = React5.forwardRef((props, forwardedRef) => {
  return /* @__PURE__ */ jsx7(Primitive.span, {
    ...props,
    ref: forwardedRef,
...
var Collapsible = React12.forwardRef((props, forwardedRef) => {
  const {
    __scopeCollapsible,
    open: openProp,
    defaultOpen,
  ...
  return /* @__PURE__ */ jsx10(CollapsibleProvider, {
...
var CollapsibleTrigger = React12.forwardRef((props, forwardedRef) => {
  const { __scopeCollapsible, ...triggerProps } = props;
  const context = useCollapsibleContext(TRIGGER_NAME, __scopeCollapsible);
  return /* @__PURE__ */ jsx10(Primitive.button, {
    type: "button",
...
var CollapsibleContent = React12.forwardRef((props, forwardedRef) => {
...
var CollapsibleContentImpl = React12.forwardRef((props, forwardedRef) => {
  ...
  const originalStylesRef = React12.useRef(undefined);
  React12.useEffect(() => {
  ...
  return /* @__PURE__ */ jsx10(Primitive.div, {
    "data-state": getState(context.open),
    "data-disabled": context.disabled ? "" : undefined,
...
var Accordion = React14.forwardRef((props, forwardedRef) => {
  const { type, ...accordionProps } = props;
  const singleProps = accordionProps;
  const multipleProps = accordionProps;
  return /* @__PURE__ */ jsx12(Collection.Provider, { scope: props.__scopeAccordion, children: type === "multiple" ? /* @__PURE__ */ jsx12(AccordionImplMultiple, { ...multipleProps, ref: forwardedRef }) : /* @__PURE__ */ jsx12(AccordionImplSingle, { ...singleProps, ref: forwardedRef }) });
});
...
var AccordionImplSingle = React14.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {},
  ...
  return /* @__PURE__ */ jsx12(AccordionValueProvider, {
    scope: props.__scopeAccordion,
    value: React14.useMemo(() => value ? [value] : [], [value]),
    onItemOpen: setValue,
    onItemClose: React14.useCallback(() => collapsible && setValue(""), [collapsible, setValue]),
    children: /* @__PURE__ */ jsx12(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible, children: /* @__PURE__ */ jsx12(AccordionImpl, { ...accordionSingleProps, ref: forwardedRef }) })
  });
});
var AccordionImplMultiple = React14.forwardRef((props, forwardedRef) => {
  ...
  const handleItemOpen = React14.useCallback((itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]), [setValue]);
  const handleItemClose = React14.useCallback((itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)), [setValue]);
  return /* @__PURE__ */ jsx12(AccordionValueProvider, {
    scope: props.__scopeAccordion,
    value,
    onItemOpen: handleItemOpen,
    onItemClose: handleItemClose,
    children: /* @__PURE__ */ jsx12(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible: true, children: /* @__PURE__ */ jsx12(AccordionImpl, { ...accordionMultipleProps, ref: forwardedRef }) })
  });
});
var [AccordionImplProvider, useAccordionContext] = createAccordionContext(ACCORDION_NAME);
var AccordionImpl = React14.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(AccordionImplProvider, {
    scope: __scopeAccordion,
    disabled,
    direction: dir,
    orientation,
    children: /* @__PURE__ */ jsx12(Collection.Slot, { scope: __scopeAccordion, children: /* @__PURE__ */ jsx12(Primitive.div, {
      ...accordionProps,
...
var AccordionItem = React14.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(AccordionItemProvider, {
    scope: __scopeAccordion,
    open,
    disabled,
    triggerId,
...
var AccordionHeader = React14.forwardRef((props, forwardedRef) => {
  const { __scopeAccordion, ...headerProps } = props;
  const accordionContext = useAccordionContext(ACCORDION_NAME, __scopeAccordion);
  const itemContext = useAccordionItemContext(HEADER_NAME, __scopeAccordion);
  return /* @__PURE__ */ jsx12(Primitive.h3, {
    "data-orientation": accordionContext.orientation,
...
var AccordionTrigger = React14.forwardRef((props, forwardedRef) => {
  ...
  const collapsibleScope = useCollapsibleScope(__scopeAccordion);
  return /* @__PURE__ */ jsx12(Collection.ItemSlot, { scope: __scopeAccordion, children: /* @__PURE__ */ jsx12(Trigger, {
...
var AccordionContent = React14.forwardRef((props, forwardedRef) => {
...
var DismissableLayer = React17.forwardRef((props, forwardedRef) => {
  const {
...
import { useState as useState10, useCallback as useCallback6, useEffect as useEffect12, useLayoutEffect as useLayoutEffect5 } from "react";
...
// ../../node_modules/@radix-ui/react-dialog/dist/index.mjs
import { Fragment as Fragment7, jsx as jsx16, jsxs } from "react/jsx-runtime";
"use client";
...
var Dialog = (props) => {
  ...
  return /* @__PURE__ */ jsx16(DialogProvider, {
    scope: __scopeDialog,
    triggerRef,
    contentRef,
    contentId: useId(),
...
var DialogTrigger = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx16(Primitive.button, {
    type: "button",
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx16(PortalProvider, { scope: __scopeDialog, forceMount, children: React34.Children.map(children, (child) => /* @__PURE__ */ jsx16(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx16(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlayImpl = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx16(Combination_default, { as: Slot2, allowPinchZoom: true, shards: [context.contentRef], children: /* @__PURE__ */ jsx16(Primitive.div, {
    "data-state": getState3(context.open),
    ...overlayProps,
    ref: forwardedRef,
...
var DialogContentModal = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx16(DialogContentImpl, {
    ...props,
    ref: composedRefs,
...
var DialogContentImpl = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment7, { children: [
    /* @__PURE__ */ jsx16(FocusScope, {
      asChild: true,
      loop: true,
      trapped: trapFocus,
      onMountAutoFocus: onOpenAutoFocus,
      onUnmountAutoFocus: onCloseAutoFocus,
      children: /* @__PURE__ */ jsx16(DismissableLayer, {
        role: "dialog",
        id: context.contentId,
...
var AlertDialog = (props) => {
  ...
  return /* @__PURE__ */ jsx17(Root3, { ...dialogScope, ...alertDialogProps, modal: true });
};
...
var AlertDialogContent = React35.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx17(WarningProvider, {
    contentName: CONTENT_NAME4,
    titleName: TITLE_NAME2,
    docsSlug: "alert-dialog",
    children: /* @__PURE__ */ jsx17(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: /* @__PURE__ */ jsxs2(Content3, {
      role: "alertdialog",
      ...dialogScope,
      ...contentProps,
      ref: composedRefs,
      ...
      children: [
        /* @__PURE__ */ jsx17(Slottable2, { children }),
...
var Avatar = React37.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx18(AvatarProvider, {
    scope: __scopeAvatar,
    imageLoadingStatus,
    onImageLoadingStatusChange: setImageLoadingStatus,
    children: /* @__PURE__ */ jsx18(Primitive.span, { ...avatarProps, ref: forwardedRef })
  });
});
...
var AvatarImage = React37.forwardRef((props, forwardedRef) => {
  ...
  return imageLoadingStatus === "loaded" ? /* @__PURE__ */ jsx18(Primitive.img, { ...imageProps, ref: forwardedRef, src }) : null;
});
...
var AvatarFallback = React37.forwardRef((props, forwardedRef) => {
  ...
  return canRender && context.imageLoadingStatus !== "loaded" ? /* @__PURE__ */ jsx18(Primitive.span, { ...fallbackProps, ref: forwardedRef }) : null;
});
...
var RovingFocusGroup = React43.forwardRef((props, forwardedRef) => {
  return /* @__PURE__ */ jsx21(Collection2.Provider, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsx21(Collection2.Slot, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsx21(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
});
...
var RovingFocusGroupImpl = React43.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx21(RovingFocusProvider, {
...
var RovingFocusGroupItem = React43.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx21(Collection2.ItemSlot, {
    scope: __scopeRovingFocusGroup,
    id,
    focusable,
    active,
    children: /* @__PURE__ */ jsx21(Primitive.span, {
...
var Menu = (props) => {
  ...
  return /* @__PURE__ */ jsx24(Root24, { ...popperScope, children: /* @__PURE__ */ jsx24(MenuProvider, {
    scope: __scopeMenu,
    open,
    onOpenChange: handleOpenChange,
    content,
    onContentChange: setContent,
    children: /* @__PURE__ */ jsx24(MenuRootProvider, {
      scope: __scopeMenu,
...
var MenuAnchor = React44.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = usePopperScope(__scopeMenu);
  return /* @__PURE__ */ jsx24(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
});
...
var MenuPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx24(PortalProvider2, { scope: __scopeMenu, forceMount, children: /* @__PURE__ */ jsx24(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx24(Portal, { asChild: true, container, children }) }) });
};
...
var MenuContent = React44.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx24(Collection3.Provider, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsx24(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx24(Collection3.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? /* @__PURE__ */ jsx24(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ jsx24(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
});
var MenuRootContentModal = React44.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx24(MenuContentImpl, {
    ...props,
    ref: composedRefs,
    trapFocus: context.open,
...
var MenuContentImpl = React44.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx24(MenuContentProvider, {
    scope: __scopeMenu,
    searchRef,
    ...
    children: /* @__PURE__ */ jsx24(ScrollLockWrapper, { ...scrollLockWrapperProps, children: /* @__PURE__ */ jsx24(FocusScope, {
      asChild: true,
      trapped: trapFocus,
      ...
      children: /* @__PURE__ */ jsx24(DismissableLayer, {
        ...
        children: /* @__PURE__ */ jsx24(Root6, {
          ...
          children: /* @__PURE__ */ jsx24(Content5, {
            role: "menu",
...
var MenuGroup = React44.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx24(Primitive.div, { role: "group", ...groupProps, ref: forwardedRef });
});
MenuGroup.displayName = GROUP_NAME2;
var LABEL_NAME = "MenuLabel";
var MenuLabel = React44.forwardRef((props, forwardedRef) => {
  const { __scopeMenu, ...labelProps } = props;
  return /* @__PURE__ */ jsx24(Primitive.div, { ...labelProps, ref: forwardedRef });
});
...
var MenuItem = React44.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx24(MenuItemImpl, {
    ...itemProps,
    ref: composedRefs,
    disabled,
...
var MenuItemImpl = React44.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx24(Collection3.ItemSlot, {
    scope: __scopeMenu,
    disabled,
    textValue: textValue ?? textContent,
    children: /* @__PURE__ */ jsx24(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: /* @__PURE__ */ jsx24(Primitive.div, {
      role: "menuitem",
...
var MenuCheckboxItem = React44.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx24(ItemIndicatorProvider, { scope: props.__scopeMenu, checked, children: /* @__PURE__ */ jsx24(MenuItem, {
...
var MenuRadioGroup = React44.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx24(RadioGroupProvider, { scope: props.__scopeMenu, value, onValueChange: handleValueChange, children: /* @__PURE__ */ jsx24(MenuGroup, { ...groupProps, ref: forwardedRef }) });
});
...
var MenuItemIndicator = React44.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx24(Presence, {
...
var MenuArrow = React44.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = usePopperScope(__scopeMenu);
  return /* @__PURE__ */ jsx24(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
});
...
var MenuSub = (props) => {
  ...
  return /* @__PURE__ */ jsx24(Root24, { ...popperScope, children: /* @__PURE__ */ jsx24(MenuProvider, {
    ...
    content,
    onContentChange: setContent,
    children: /* @__PURE__ */ jsx24(MenuSubProvider, {
      scope: __scopeMenu,
      contentId: useId(),
      triggerId: useId(),
      trigger,
...
var MenuSubTrigger = React44.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx24(MenuAnchor, { asChild: true, ...scope, children: /* @__PURE__ */ jsx24(MenuItemImpl, {
...
var MenuSubContent = React44.forwardRef((props, forwardedRef) => {
  ...
  const ref = React44.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  return /* @__PURE__ */ jsx24(Collection3.Provider, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsx24(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx24(Collection3.Slot, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsx24(MenuContentImpl, {
...
var ContextMenu = (props) => {
  ...
  return /* @__PURE__ */ jsx26(ContextMenuProvider, {
    scope: __scopeContextMenu,
    open,
    onOpenChange: handleOpenChange,
    modal,
    children: /* @__PURE__ */ jsx26(Root32, {
      ...menuScope,
      dir,
      open,
      onOpenChange: handleOpenChange,
...
var ContextMenuTrigger = React45.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxs3(Fragment9, { children: [
    /* @__PURE__ */ jsx26(Anchor2, { ...menuScope, virtualRef }),
    /* @__PURE__ */ jsx26(Primitive.span, {
...
var ContextMenuContent = React45.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx26(Content23, {
    ...menuScope,
    ...contentProps,
    ref: forwardedRef,
    side: "right",
...
var ContextMenuSubTrigger = React45.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return /* @__PURE__ */ jsx26(SubTrigger, { ...menuScope, ...triggerItemProps, ref: forwardedRef });
});
...
var ContextMenuSubContent = React45.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return /* @__PURE__ */ jsx26(SubContent, {
    ...menuScope,
    ...subContentProps,
    ref: forwardedRef,
    style: {
...
var DropdownMenu = (props) => {
  ...
  return /* @__PURE__ */ jsx27(DropdownMenuProvider, {
    ...
    modal,
    children: /* @__PURE__ */ jsx27(Root32, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
  });
};
...
var DropdownMenuTrigger = React46.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return /* @__PURE__ */ jsx27(Anchor2, { asChild: true, ...menuScope, children: /* @__PURE__ */ jsx27(Primitive.button, {
    type: "button",
...
var DropdownMenuSubTrigger = React46.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return /* @__PURE__ */ jsx27(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
});
...
var Label3 = React47.forwardRef((props, forwardedRef) => {
  return /* @__PURE__ */ jsx28(Primitive.label, {
    ...props,
    ref: forwardedRef,
    onMouseDown: (event) => {
      const target = event.target;
...
var HoverCard = (props) => {
  ...
  return /* @__PURE__ */ jsx29(HoverCardProvider, {
    ...
    children: /* @__PURE__ */ jsx29(Root24, { ...popperScope, children })
  });
};
...
var HoverCardTrigger = React48.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = usePopperScope2(__scopeHoverCard);
  return /* @__PURE__ */ jsx29(Anchor, { asChild: true, ...popperScope, children: /* @__PURE__ */ jsx29(Primitive.a, {
    "data-state": context.open ? "open" : "closed",
    ...triggerProps,
    ref: forwardedRef,
...
var HoverCardPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx29(PortalProvider3, { scope: __scopeHoverCard, forceMount, children: /* @__PURE__ */ jsx29(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx29(Portal, { asChild: true, container, children }) }) });
};
...
var HoverCardContent = React48.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx29(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx29(HoverCardContentImpl, {
    "data-state": context.open ? "open" : "closed",
    ...contentProps,
    onPointerEnter: composeEventHandlers(props.onPointerEnter, excludeTouch(context.onOpen)),
    onPointerLeave: composeEventHandlers(props.onPointerLeave, excludeTouch(context.onClose)),
...
var HoverCardContentImpl = React48.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx29(DismissableLayer, {
    asChild: true,
    disableOutsidePointerEvents: false,
    onInteractOutside,
    onEscapeKeyDown,
    ...
    children: /* @__PURE__ */ jsx29(Content5, {
      ...popperScope,
      ...contentProps,
...
var Menubar = React49.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx30(MenubarContextProvider, {
    ...
    dir: direction,
    loop,
    children: /* @__PURE__ */ jsx30(Collection4.Provider, { scope: __scopeMenubar, children: /* @__PURE__ */ jsx30(Collection4.Slot, { scope: __scopeMenubar, children: /* @__PURE__ */ jsx30(Root6, {
      asChild: true,
      ...rovingFocusGroupScope,
      ...
      children: /* @__PURE__ */ jsx30(Primitive.div, { role: "menubar", ...menubarProps, ref: forwardedRef })
    }) }) })
  });
});
...
var MenubarMenu = (props) => {
  ...
  return /* @__PURE__ */ jsx30(MenubarMenuProvider, {
    scope: __scopeMenubar,
    value,
    triggerId: useId(),
    triggerRef,
    ...
    children: /* @__PURE__ */ jsx30(Root32, {
      ...menuScope,
      open,
      onOpenChange: (open2) => {
        if (!open2)
...
var MenubarTrigger = React49.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx30(Collection4.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: /* @__PURE__ */ jsx30(Item2, {
    asChild: true,
    ...rovingFocusGroupScope,
    focusable: !disabled,
    tabStopId: menuContext.value,
    children: /* @__PURE__ */ jsx30(Anchor2, { asChild: true, ...menuScope, children: /* @__PURE__ */ jsx30(Primitive.button, {
      type: "button",
      role: "menuitem",
...
var MenubarPortal = (props) => {
  ...
  const menuScope = useMenuScope3(__scopeMenubar);
  return /* @__PURE__ */ jsx30(Portal3, { ...menuScope, ...portalProps });
};
...
var MenubarContent = React49.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx30(Content23, {
...
var MenubarGroup = React49.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope3(__scopeMenubar);
  return /* @__PURE__ */ jsx30(Group, { ...menuScope, ...groupProps, ref: forwardedRef });
});
...
var MenubarItem = React49.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope3(__scopeMenubar);
  return /* @__PURE__ */ jsx30(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
});
...
var MenubarSubTrigger = React49.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope3(__scopeMenubar);
  return /* @__PURE__ */ jsx30(SubTrigger, {
...
var MenubarSubContent = React49.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope3(__scopeMenubar);
  return /* @__PURE__ */ jsx30(SubContent, {
    ...menuScope,
    "data-radix-menubar-content": "",
    ...subContentProps,
    ref: forwardedRef,
...
import { Fragment as Fragment10, jsx as jsx31, jsxs as jsxs4 } from "react/jsx-runtime";
"use client";
...
var NavigationMenu = React50.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx31(NavigationMenuProvider, {
    ...
    children: /* @__PURE__ */ jsx31(Primitive.nav, {
      "aria-label": "Main",
      "data-orientation": orientation,
      dir: direction,
      ...NavigationMenuProps,
...
var NavigationMenuSub = React50.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx31(NavigationMenuProvider, {
    ...
    onItemDismiss: () => setValue(""),
    children: /* @__PURE__ */ jsx31(Primitive.div, { "data-orientation": orientation, ...subProps, ref: forwardedRef })
  });
});
...
var NavigationMenuProvider = (props) => {
  ...
  return /* @__PURE__ */ jsx31(NavigationMenuProviderImpl, {
    scope,
    isRootMenu,
    rootNavigationMenu,
    value,
    ...
    children: /* @__PURE__ */ jsx31(Collection5.Provider, { scope, children: /* @__PURE__ */ jsx31(ViewportContentProvider, { scope, items: viewportContent, children }) })
  });
};
...
var NavigationMenuList = React50.forwardRef((props, forwardedRef) => {
  ...
  const list = /* @__PURE__ */ jsx31(Primitive.ul, { "data-orientation": context.orientation, ...listProps, ref: forwardedRef });
  return /* @__PURE__ */ jsx31(Primitive.div, { style: { position: "relative" }, ref: context.onIndicatorTrackChange, children: /* @__PURE__ */ jsx31(Collection5.Slot, { scope: __scopeNavigationMenu, children: context.isRootMenu ? /* @__PURE__ */ jsx31(FocusGroup, { asChild: true, children: list }) : list }) });
});
...
var NavigationMenuItem = React50.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx31(NavigationMenuItemContextProvider, {
    scope: __scopeNavigationMenu,
    value,
    triggerRef,
    contentRef,
    ...
    children: /* @__PURE__ */ jsx31(Primitive.li, { ...itemProps, ref: forwardedRef })
  });
});
...
var NavigationMenuTrigger = React50.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxs4(Fragment10, { children: [
    /* @__PURE__ */ jsx31(Collection5.ItemSlot, { scope: __scopeNavigationMenu, value: itemContext.value, children: /* @__PURE__ */ jsx31(FocusGroupItem, { asChild: true, children: /* @__PURE__ */ jsx31(Primitive.button, {
      id: triggerId,
      disabled,
      "data-disabled": disabled ? "" : undefined,
    ...
    open && /* @__PURE__ */ jsxs4(Fragment10, { children: [
      /* @__PURE__ */ jsx31(Root, {
        "aria-hidden": true,
        tabIndex: 0,
      ...
      context.viewport && /* @__PURE__ */ jsx31("span", { "aria-owns": contentId })
    ] })
  ] });
});
...
var NavigationMenuLink = React50.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx31(FocusGroupItem, { asChild: true, children: /* @__PURE__ */ jsx31(Primitive.a, {
...
var NavigationMenuIndicator = React50.forwardRef((props, forwardedRef) => {
  ...
  return context.indicatorTrack ? ReactDOM4.createPortal(/* @__PURE__ */ jsx31(Presence, { present: forceMount || isVisible, children: /* @__PURE__ */ jsx31(NavigationMenuIndicatorImpl, { ...indicatorProps, ref: forwardedRef }) }), context.indicatorTrack) : null;
});
...
var NavigationMenuIndicatorImpl = React50.forwardRef((props, forwardedRef) => {
  ...
  return position ? /* @__PURE__ */ jsx31(Primitive.div, {
    "aria-hidden": true,
...
var NavigationMenuContent = React50.forwardRef((props, forwardedRef) => {
  ...
  return !context.viewport ? /* @__PURE__ */ jsx31(Presence, { present: forceMount || open, children: /* @__PURE__ */ jsx31(NavigationMenuContentImpl, {
    "data-state": getOpenState2(open),
    ...commonProps,
    ref: composedRefs,
  ...
  }) }) : /* @__PURE__ */ jsx31(ViewportContentMounter, { forceMount, ...commonProps, ref: composedRefs });
});
...
var NavigationMenuContentImpl = React50.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx31(FocusGroup, { asChild: true, children: /* @__PURE__ */ jsx31(DismissableLayer, {
    id: contentId,
...
var NavigationMenuViewport = React50.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx31(Presence, { present: forceMount || open, children: /* @__PURE__ */ jsx31(NavigationMenuViewportImpl, { ...viewportProps, ref: forwardedRef }) });
});
...
var NavigationMenuViewportImpl = React50.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx31(Primitive.div, {
    "data-state": getOpenState2(open),
    "data-orientation": context.orientation,
    ...viewportImplProps,
    ref: composedRefs,
    ...
    children: Array.from(viewportContentContext.items).map(([value, { ref, forceMount, ...props2 }]) => {
      ...
      return /* @__PURE__ */ jsx31(Presence, { present: forceMount || isActive, children: /* @__PURE__ */ jsx31(NavigationMenuContentImpl, {
        ...props2,
...
var FocusGroup = React50.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx31(FocusGroupCollection.Provider, { scope: __scopeNavigationMenu, children: /* @__PURE__ */ jsx31(FocusGroupCollection.Slot, { scope: __scopeNavigationMenu, children: /* @__PURE__ */ jsx31(Primitive.div, { dir: context.dir, ...groupProps, ref: forwardedRef }) }) });
});
...
var FocusGroupItem = React50.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx31(FocusGroupCollection.ItemSlot, { scope: __scopeNavigationMenu, children: /* @__PURE__ */ jsx31(Primitive.button, {
    ...groupProps,
    ref: forwardedRef,
    onKeyDown: composeEventHandlers(props.onKeyDown, (event) => {
...
var Popover = (props) => {
  ...
  return /* @__PURE__ */ jsx32(Root24, { ...popperScope, children: /* @__PURE__ */ jsx32(PopoverProvider, {
...
var PopoverAnchor = React51.forwardRef((props, forwardedRef) => {
...
var PopoverTrigger = React51.forwardRef((props, forwardedRef) => {
  const { __scopePopover, ...triggerProps } = props;
  const context = usePopoverContext(TRIGGER_NAME10, __scopePopover);
  const popperScope = usePopperScope3(__scopePopover);
  const composedTriggerRef = useComposedRefs(forwardedRef, context.triggerRef);
  const trigger = /* @__PURE__ */ jsx32(Primitive.button, {
    type: "button",
    "aria-haspopup": "dialog",
    "aria-expanded": context.open,
    "aria-controls": context.contentId,
...
var PopoverContent = React51.forwardRef((props, forwardedRef) => {
...
var PopoverContentModal = React51.forwardRef((props, forwardedRef) => {
  const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
  ...
  return /* @__PURE__ */ jsx32(Combination_default, { as: Slot4, allowPinchZoom: true, children: /* @__PURE__ */ jsx32(PopoverContentImpl, {
    ...props,
    ref: composedRefs,
    trapFocus: context.open,
    disableOutsidePointerEvents: true,
...
var PopoverContentNonModal = React51.forwardRef((props, forwardedRef) => {
  const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
  const hasInteractedOutsideRef = React51.useRef(false);
  const hasPointerDownOutsideRef = React51.useRef(false);
  return /* @__PURE__ */ jsx32(PopoverContentImpl, {
    ...props,
    ref: forwardedRef,
    trapFocus: false,
    disableOutsidePointerEvents: false,
...
var PopoverContentImpl = React51.forwardRef((props, forwardedRef) => {
  const {
    __scopePopover,
    trapFocus,
    onOpenAutoFocus,
  ...
  const popperScope = usePopperScope3(__scopePopover);
  useFocusGuards();
  return /* @__PURE__ */ jsx32(FocusScope, {
    asChild: true,
    loop: true,
    trapped: trapFocus,
    onMountAutoFocus: onOpenAutoFocus,
    onUnmountAutoFocus: onCloseAutoFocus,
    children: /* @__PURE__ */ jsx32(DismissableLayer, {
      asChild: true,
      disableOutsidePointerEvents,
      onInteractOutside,
      onEscapeKeyDown,
      ...
      onFocusOutside,
      onDismiss: () => context.onOpenChange(false),
      children: /* @__PURE__ */ jsx32(Content5, {
        "data-state": getState4(context.open),
        role: "dialog",
        id: context.contentId,
        ...popperScope,
...
var PopoverClose = React51.forwardRef((props, forwardedRef) => {
  const { __scopePopover, ...closeProps } = props;
  const context = usePopoverContext(CLOSE_NAME2, __scopePopover);
  return /* @__PURE__ */ jsx32(Primitive.button, {
    type: "button",
    ...closeProps,
    ref: forwardedRef,
    onClick: composeEventHandlers(props.onClick, () => context.onOpenChange(false))
...
var PopoverArrow = React51.forwardRef((props, forwardedRef) => {
...
var Radio = React52.forwardRef((props, forwardedRef) => {
  const {
    __scopeRadio,
    name,
    checked = false,
  ...
  return /* @__PURE__ */ jsxs5(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
    /* @__PURE__ */ jsx33(Primitive.button, {
      type: "button",
      role: "radio",
      "aria-checked": checked,
    ...
    isFormControl && /* @__PURE__ */ jsx33(RadioBubbleInput, {
      control: button,
...
var RadioIndicator = React52.forwardRef((props, forwardedRef) => {
  const { __scopeRadio, forceMount, ...indicatorProps } = props;
  const context = useRadioContext(INDICATOR_NAME5, __scopeRadio);
  return /* @__PURE__ */ jsx33(Presence, { present: forceMount || context.checked, children: /* @__PURE__ */ jsx33(Primitive.span, {
...
var RadioBubbleInput = React52.forwardRef(({
  ...
  return /* @__PURE__ */ jsx33(Primitive.input, {
    type: "radio",
    "aria-hidden": true,
...
import { Fragment as Fragment11, jsx as jsx34, jsxs as jsxs6 } from "react/jsx-runtime";
"use client";
...
var ScrollArea = React210.forwardRef((props, forwardedRef) => {
  ...
  const direction = useDirection(dir);
  return /* @__PURE__ */ jsx34(ScrollAreaProvider, {
    ...
    children: /* @__PURE__ */ jsx34(Primitive.div, {
      dir: direction,
      ...scrollAreaProps,
      ref: composedRefs,
      style: {
...
var ScrollAreaViewport = React210.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxs6(Fragment11, { children: [
    /* @__PURE__ */ jsx34("style", {
      dangerouslySetInnerHTML: {
        __html: `[data-radix-scroll-area-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-radix-scroll-area-viewport]::-webkit-scrollbar{display:none}`
      },
      nonce
    }),
    /* @__PURE__ */ jsx34(Primitive.div, {
      ...
      children: /* @__PURE__ */ jsx34("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" }, children })
    })
  ] });
});
...
var ScrollAreaScrollbar = React210.forwardRef((props, forwardedRef) => {
  ...
  return context.type === "hover" ? /* @__PURE__ */ jsx34(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? /* @__PURE__ */ jsx34(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? /* @__PURE__ */ jsx34(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? /* @__PURE__ */ jsx34(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
});
...
var ScrollAreaScrollbarHover = React210.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx34(Presence, { present: forceMount || visible, children: /* @__PURE__ */ jsx34(ScrollAreaScrollbarAuto, {
...
var ScrollAreaScrollbarScroll = React210.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx34(Presence, { present: forceMount || state !== "hidden", children: /* @__PURE__ */ jsx34(ScrollAreaScrollbarVisible, {
...
var ScrollAreaScrollbarAuto = React210.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx34(Presence, { present: forceMount || visible, children: /* @__PURE__ */ jsx34(ScrollAreaScrollbarVisible, {
    "data-state": visible ? "visible" : "hidden",
    ...scrollbarProps,
    ref: forwardedRef
  }) });
...
var ScrollAreaScrollbarVisible = React210.forwardRef((props, forwardedRef) => {
  ...
  if (orientation === "horizontal") {
    return /* @__PURE__ */ jsx34(ScrollAreaScrollbarX, {
      ...commonProps,
      ref: forwardedRef,
  ...
  if (orientation === "vertical") {
    return /* @__PURE__ */ jsx34(ScrollAreaScrollbarY, {
      ...commonProps,
      ref: forwardedRef,
      onThumbPositionChange: () => {
        if (context.viewport && thumbRef.current) {
...
var ScrollAreaScrollbarX = React210.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx34(ScrollAreaScrollbarImpl, {
...
var ScrollAreaScrollbarImpl = React210.forwardRef((props, forwardedRef) => {
  ...
  useResizeObserver2(context.content, handleResize);
  return /* @__PURE__ */ jsx34(ScrollbarProvider, {
    scope: __scopeScrollArea,
    scrollbar,
    hasThumb,
...
var ScrollAreaThumb = React210.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx34(Presence, { present: forceMount || scrollbarContext.hasThumb, children: /* @__PURE__ */ jsx34(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
});
var ScrollAreaThumbImpl = React210.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx34(Primitive.div, {
...
var ScrollAreaCorner = React210.forwardRef((props, forwardedRef) => {
  ...
  return hasCorner ? /* @__PURE__ */ jsx34(ScrollAreaCornerImpl, { ...props, ref: forwardedRef }) : null;
});
...
var ScrollAreaCornerImpl = React210.forwardRef((props, forwardedRef) => {
  ...
  return hasSize ? /* @__PURE__ */ jsx34(Primitive.div, {
    ...cornerProps,
    ref: forwardedRef,
    style: {
      width,
...
import { Fragment as Fragment12, jsx as jsx35, jsxs as jsxs7 } from "react/jsx-runtime";
"use client";
...
var Select = (props) => {
  ...
  return /* @__PURE__ */ jsx35(Root24, { ...popperScope, children: /* @__PURE__ */ jsxs7(SelectProvider, {
    required,
    scope: __scopeSelect,
    trigger,
    onTriggerChange: setTrigger,
    ...
    disabled,
    children: [
      /* @__PURE__ */ jsx35(Collection6.Provider, { scope: __scopeSelect, children: /* @__PURE__ */ jsx35(SelectNativeOptionsProvider, {
      ...
      isFormControl ? /* @__PURE__ */ jsxs7(SelectBubbleInput, {
        ...
        form,
        children: [
          value === undefined ? /* @__PURE__ */ jsx35("option", { value: "" }) : null,
...
var SelectTrigger = React54.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx35(Anchor, { asChild: true, ...popperScope, children: /* @__PURE__ */ jsx35(Primitive.button, {
    type: "button",
    role: "combobox",
    "aria-controls": context.contentId,
    "aria-expanded": context.open,
...
var SelectValue = React54.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx35(Primitive.span, {
    ...valueProps,
    ref: composedRefs,
    style: { pointerEvents: "none" },
    children: shouldShowPlaceholder(context.value) ? /* @__PURE__ */ jsx35(Fragment12, { children: placeholder }) : children
  });
});
SelectValue.displayName = VALUE_NAME;
var ICON_NAME = "SelectIcon";
var SelectIcon = React54.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, children, ...iconProps } = props;
  return /* @__PURE__ */ jsx35(Primitive.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
});
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME10 = "SelectPortal";
var SelectPortal = (props) => {
  return /* @__PURE__ */ jsx35(Portal, { asChild: true, ...props });
};
SelectPortal.displayName = PORTAL_NAME10;
var CONTENT_NAME13 = "SelectContent";
var SelectContent = React54.forwardRef((props, forwardedRef) => {
  ...
  if (!context.open) {
    const frag = fragment;
    return frag ? ReactDOM5.createPortal(/* @__PURE__ */ jsx35(SelectContentProvider, { scope: props.__scopeSelect, children: /* @__PURE__ */ jsx35(Collection6.Slot, { scope: props.__scopeSelect, children: /* @__PURE__ */ jsx35("div", { children: props.children }) }) }), frag) : null;
  }
  return /* @__PURE__ */ jsx35(SelectContentImpl, { ...props, ref: forwardedRef });
});
...
var SelectContentImpl = React54.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
  ...
  const [selectedItemText, setSelectedItemText] = React54.useState(null);
  const getItems = useCollection6(__scopeSelect);
  ...
  useFocusGuards();
  const focusFirst5 = React54.useCallback((candidates) => {
  ...
  const focusSelectedItem = React54.useCallback(() => focusFirst5([selectedItem, content]), [focusFirst5, selectedItem, content]);
  React54.useEffect(() => {
    if (isPositioned) {
      focusSelectedItem();
    }
  ...
  const itemRefCallback = React54.useCallback((node, value, disabled) => {
  ...
  const itemTextRefCallback = React54.useCallback((node, value, disabled) => {
    const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
    const isSelectedItem = context.value !== undefined && context.value === value;
    if (isSelectedItem || isFirstValidItem) {
  ...
  return /* @__PURE__ */ jsx35(SelectContentProvider, {
    scope: __scopeSelect,
    content,
    viewport,
    onViewportChange: setViewport,
    ...
    isPositioned,
    searchRef,
    children: /* @__PURE__ */ jsx35(Combination_default, { as: Slot5, allowPinchZoom: true, children: /* @__PURE__ */ jsx35(FocusScope, {
      asChild: true,
      ...
      children: /* @__PURE__ */ jsx35(DismissableLayer, {
        asChild: true,
        disableOutsidePointerEvents: true,
        onEscapeKeyDown,
        onPointerDownOutside,
        ...
        onDismiss: () => context.onOpenChange(false),
        children: /* @__PURE__ */ jsx35(SelectPosition, {
          role: "listbox",
          id: context.contentId,
          "data-state": context.open ? "open" : "closed",
          dir: context.dir,
...
var SelectItemAlignedPosition = React54.forwardRef((props, forwardedRef) => {
  ...
  const handleScrollButtonChange = React54.useCallback((node) => {
  ...
  return /* @__PURE__ */ jsx35(SelectViewportProvider, {
    scope: __scopeSelect,
    contentWrapper,
    ...
    children: /* @__PURE__ */ jsx35("div", {
      ...
      children: /* @__PURE__ */ jsx35(Primitive.div, {
        ...popperProps,
        ref: composedRefs,
        style: {
...
var SelectPopperPosition = React54.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = usePopperScope4(__scopeSelect);
  return /* @__PURE__ */ jsx35(Content5, {
    ...popperScope,
    ...popperProps,
    ref: forwardedRef,
    align,
...
var SelectViewport = React54.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxs7(Fragment12, { children: [
    /* @__PURE__ */ jsx35("style", {
      dangerouslySetInnerHTML: {
        __html: `[data-radix-select-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-radix-select-viewport]::-webkit-scrollbar{display:none}`
      },
      nonce
    }),
    /* @__PURE__ */ jsx35(Collection6.Slot, { scope: __scopeSelect, children: /* @__PURE__ */ jsx35(Primitive.div, {
...
var SelectGroup = React54.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, ...groupProps } = props;
  const groupId = useId();
  return /* @__PURE__ */ jsx35(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: /* @__PURE__ */ jsx35(Primitive.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
});
SelectGroup.displayName = GROUP_NAME6;
var LABEL_NAME5 = "SelectLabel";
var SelectLabel = React54.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, ...labelProps } = props;
  const groupContext = useSelectGroupContext(LABEL_NAME5, __scopeSelect);
  return /* @__PURE__ */ jsx35(Primitive.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
});
...
var SelectItem = React54.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    value,
    disabled = false,
  ...
  return /* @__PURE__ */ jsx35(SelectItemContextProvider, {
    scope: __scopeSelect,
    value,
    disabled,
    textId,
    ...
    children: /* @__PURE__ */ jsx35(Collection6.ItemSlot, {
      scope: __scopeSelect,
      value,
      disabled,
      textValue,
...
var SelectItemText = React54.forwardRef((props, forwardedRef) => {
  ...
  const nativeOption = React54.useMemo(() => /* @__PURE__ */ jsx35("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value), [itemContext.disabled, itemContext.value, textContent]);
  ...
  return /* @__PURE__ */ jsxs7(Fragment12, { children: [
    /* @__PURE__ */ jsx35(Primitive.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React54.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, ...itemIndicatorProps } = props;
  const itemContext = useSelectItemContext(ITEM_INDICATOR_NAME2, __scopeSelect);
  return itemContext.isSelected ? /* @__PURE__ */ jsx35(Primitive.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
});
...
var SelectScrollUpButton = React54.forwardRef((props, forwardedRef) => {
  ...
  return canScrollUp ? /* @__PURE__ */ jsx35(SelectScrollButtonImpl, {
    ...props,
    ref: composedRefs,
    onAutoScroll: () => {
...
var SelectScrollDownButton = React54.forwardRef((props, forwardedRef) => {
  ...
  return canScrollDown ? /* @__PURE__ */ jsx35(SelectScrollButtonImpl, {
    ...props,
    ref: composedRefs,
    onAutoScroll: () => {
      const { viewport, selectedItem } = contentContext;
...
var SelectScrollButtonImpl = React54.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx35(Primitive.div, {
    "aria-hidden": true,
...
var SelectSeparator = React54.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, ...separatorProps } = props;
  return /* @__PURE__ */ jsx35(Primitive.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
});
SelectSeparator.displayName = SEPARATOR_NAME5;
var ARROW_NAME8 = "SelectArrow";
var SelectArrow = React54.forwardRef((props, forwardedRef) => {
  ...
  return context.open && contentContext.position === "popper" ? /* @__PURE__ */ jsx35(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
});
SelectArrow.displayName = ARROW_NAME8;
var BUBBLE_INPUT_NAME2 = "SelectBubbleInput";
var SelectBubbleInput = React54.forwardRef(({ __scopeSelect, value, ...props }, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx35(Primitive.select, {
    ...props,
    style: { ...VISUALLY_HIDDEN_STYLES, ...props.style },
    ref: composedRefs,
    defaultValue: value
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React54.useCallback((key) => {
    const search = searchRef.current + key;
...
var Separator5 = React55.forwardRef((props, forwardedRef) => {
  const { decorative, orientation: orientationProp = DEFAULT_ORIENTATION, ...domProps } = props;
  const orientation = isValidOrientation(orientationProp) ? orientationProp : DEFAULT_ORIENTATION;
  const ariaOrientation = orientation === "vertical" ? orientation : undefined;
  const semanticProps = decorative ? { role: "none" } : { "aria-orientation": ariaOrientation, role: "separator" };
  return /* @__PURE__ */ jsx36(Primitive.div, {
    "data-orientation": orientation,
    ...semanticProps,
    ...domProps,
    ref: forwardedRef
...
var Tabs = React56.forwardRef((props, forwardedRef) => {
  const {
    __scopeTabs,
    value: valueProp,
    onValueChange,
  ...
  return /* @__PURE__ */ jsx37(TabsProvider, {
    scope: __scopeTabs,
    baseId: useId(),
    value,
    onValueChange: setValue,
    ...
    dir: direction,
    activationMode,
    children: /* @__PURE__ */ jsx37(Primitive.div, {
      dir: direction,
      "data-orientation": orientation,
      ...tabsProps,
      ref: forwardedRef
...
var TabsTrigger = React56.forwardRef((props, forwardedRef) => {
  ...
  const isSelected = value === context.value;
  return /* @__PURE__ */ jsx37(Item2, {
    asChild: true,
    ...rovingFocusGroupScope,
    focusable: !disabled,
    active: isSelected,
    children: /* @__PURE__ */ jsx37(Primitive.button, {
      type: "button",
      role: "tab",
...
var TabsContent = React56.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx37(Presence, { present: forceMount || isSelected, children: ({ present }) => /* @__PURE__ */ jsx37(Primitive.div, {
    "data-state": isSelected ? "active" : "inactive",
    "data-orientation": context.orientation,
    role: "tabpanel",
    "aria-labelledby": triggerId,
...
"use client";
var NAME5 = "Toggle";
var Toggle = React57.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx38(Primitive.button, {
    type: "button",
...
var ToggleGroup = React58.forwardRef((props, forwardedRef) => {
...
var ToggleGroupImplSingle = React58.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {},
  ...
  return /* @__PURE__ */ jsx39(ToggleGroupValueProvider, {
    scope: props.__scopeToggleGroup,
    type: "single",
    value: React58.useMemo(() => value ? [value] : [], [value]),
    onItemActivate: setValue,
    onItemDeactivate: React58.useCallback(() => setValue(""), [setValue]),
    children: /* @__PURE__ */ jsx39(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
  });
});
var ToggleGroupImplMultiple = React58.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {},
  ...
  const handleButtonActivate = React58.useCallback((itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]), [setValue]);
  const handleButtonDeactivate = React58.useCallback((itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)), [setValue]);
  return /* @__PURE__ */ jsx39(ToggleGroupValueProvider, {
    scope: props.__scopeToggleGroup,
    type: "multiple",
    value,
...
var ToggleGroupImpl = React58.forwardRef((props, forwardedRef) => {
  const {
    __scopeToggleGroup,
    disabled = false,
    rovingFocus = true,
  ...
  return /* @__PURE__ */ jsx39(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? /* @__PURE__ */ jsx39(Root6, {
    asChild: true,
    ...rovingFocusGroupScope,
    orientation,
    dir: direction,
...
var ToggleGroupItem = React58.forwardRef((props, forwardedRef) => {
  ...
  return context.rovingFocus ? /* @__PURE__ */ jsx39(Item2, {
    asChild: true,
    ...rovingFocusGroupScope,
    focusable: !disabled,
    active: pressed,
...
var ToggleGroupItemImpl = React58.forwardRef((props, forwardedRef) => {
...
var TooltipProvider = (props) => {
  ...
  return /* @__PURE__ */ jsx40(TooltipProviderContextProvider, {
...
var Tooltip = (props) => {
  ...
  return /* @__PURE__ */ jsx40(Root24, { ...popperScope, children: /* @__PURE__ */ jsx40(TooltipContextProvider, {
    scope: __scopeTooltip,
    contentId,
    open,
    stateAttribute,
...
var TooltipTrigger = React59.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx40(Anchor, { asChild: true, ...popperScope, children: /* @__PURE__ */ jsx40(Primitive.button, {
...
var TooltipContent = React59.forwardRef((props, forwardedRef) => {
...
var TooltipContentHoverable = React59.forwardRef((props, forwardedRef) => {
  ...
  const handleCreateGraceArea = React59.useCallback((event, hoverTarget) => {
...
var TooltipContentImpl = React59.forwardRef((props, forwardedRef) => {
  const {
    __scopeTooltip,
    children,
  ...
  return /* @__PURE__ */ jsx40(DismissableLayer, {
    asChild: true,
    disableOutsidePointerEvents: false,
    onEscapeKeyDown,
    onPointerDownOutside,
...
var TooltipArrow = React59.forwardRef((props, forwardedRef) => {
...
import { jsx as jsx5, jsxs as jsxs22 } from "react/jsx-runtime";
import React60 from "react";
import { Link as RouterLink } from "react-router";
import { jsx as jsx62 } from "react/jsx-runtime";
import { jsx as jsx72, jsxs as jsxs32, Fragment as Fragment14 } from "react/jsx-runtime";
...
import { useEffect as useEffect34, useState as useState210 } from "react";
import { jsx as jsx92 } from "react/jsx-runtime";
var LoadingBar = memo3(({ className }) => /* @__PURE__ */ jsx41("div", {
  className: clsx5("loading-bar", className)
}));
function SpriteIcon2({ url, id, ...props }) {
  return /* @__PURE__ */ jsx210("svg", {
    ...props,
    children: id ? /* @__PURE__ */ jsx210("use", {
      href: `${url}#${id}`
    }) : /* @__PURE__ */ jsx210("use", {
      href: `${url}`
    })
...
var Link2 = React60.forwardRef(function Link22(props, ref) {
...
var ThemeSwitchButton = ({ themeContext, theme, spriteUrl, className, classTheme }) => {
  ...
  return /* @__PURE__ */ jsx92("button", {
    ...
    children: resolvedTheme === theme.theme.dark ? /* @__PURE__ */ jsx92(SpriteIcon2, {
      url: spriteUrl,
      id: "Moon",
      className: clsx7("size-5", className)
    }) : /* @__PURE__ */ jsx92(SpriteIcon2, {
      url: spriteUrl,
      id: "Sun",
      className: clsx7("size-5", className)
    })
...
var ThemeSwitch = ({ theme = THEME_OPTIONS, spriteUrl, className, classTheme, children }) => {
  ...
  return /* @__PURE__ */ jsx92(ThemeSwitchButton, {
    themeContext,
    theme,
    spriteUrl,
    className,
...
// ../componentry/dist/shadcn-ui/index.js
...
var xe = t2.forwardRef((r, o) => {
  ...
  return t2.createElement(Root3, { open: n, onOpenChange: u2 }, t2.createElement(Portal2, { container: f }, t2.createElement(Overlay, { "cmdk-overlay": "", className: c }), t2.createElement(Content3, { "aria-label": r.label, "cmdk-dialog": "", className: d }, t2.createElement(me, { ref: o, ...p2 }))));
});
...
import { jsx as jsx213, jsxs as jsxs92 } from "react/jsx-runtime";
import clsx19 from "clsx";
import { jsx as jsx222, jsxs as jsxs102 } from "react/jsx-runtime";
...
import { jsx as jsx262, jsxs as jsxs11 } from "react/jsx-runtime";
import clsx24 from "clsx";
import { jsx as jsx272, jsxs as jsxs12 } from "react/jsx-runtime";
...
import { jsx as jsx313, jsxs as jsxs14 } from "react/jsx-runtime";
import { jsx as jsx322, jsxs as jsxs15 } from "react/jsx-runtime";
import clsx30 from "clsx";
import React310 from "react";
import { jsx as jsx332, jsxs as jsxs16 } from "react/jsx-runtime";
  ...
  constructor() {
    ...
    this.promise = (promise, data) => {
      ...
      const originalPromise = p2.then(async (response) => {
        ...
        const isReactElementResponse = React61.isValidElement(response);
        if (isReactElementResponse) {
          ...
          const isExtendedResult = typeof promiseData === "object" && !React61.isValidElement(promiseData);
...
function SpriteIcon3({ url, id, ...props }) {
  return /* @__PURE__ */ jsx43("svg", {
    ...props,
    children: id ? /* @__PURE__ */ jsx43("use", {
      href: `${url}#${id}`
    }) : /* @__PURE__ */ jsx43("use", {
      href: `${url}`
    })
...
function Accordion2({ ...props }) {
  return /* @__PURE__ */ jsx212(exports_dist3.Root, {
    "data-slot": "accordion",
    ...props
  });
}
function AccordionItem2({ className, ...props }) {
  return /* @__PURE__ */ jsx212(exports_dist3.Item, {
    "data-slot": "accordion-item",
    className: clsx8("border-b last:border-b-0", className),
    ...props
  });
}
function AccordionTrigger2({ className, children, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsx212(exports_dist3.Header, {
    className: "flex",
    children: /* @__PURE__ */ jsxs10(exports_dist3.Trigger, {
      "data-slot": "accordion-trigger",
      className: clsx8("flex flex-1 items-start justify-between gap-4 rounded-md py-4 text-left font-medium text-sm outline-none transition-all hover:underline focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 [&[data-state=open]>svg]:rotate-180", className),
      ...props,
      children: [
        children,
        /* @__PURE__ */ jsx212(SpriteIcon3, {
          id: "ChevronDown",
          url: spriteUrl,
...
function AccordionContent2({ className, children, ...props }) {
  return /* @__PURE__ */ jsx212(exports_dist3.Content, {
    "data-slot": "accordion-content",
    className: "overflow-hidden text-sm data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down",
    ...props,
    children: /* @__PURE__ */ jsx212("div", {
      className: clsx8("pt-0 pb-4", className),
      children
    })
  });
}
...
function Button({
  ...
  return /* @__PURE__ */ jsx312(Comp, {
    "data-slot": "button",
    className: clsx23(buttonVariants2({ variant, size: size4, className })),
    ...props
  });
}
function AlertDialog2({ ...props }) {
  return /* @__PURE__ */ jsx44(exports_dist5.Root, {
    "data-slot": "alert-dialog",
    ...props
  });
}
function AlertDialogTrigger2({ ...props }) {
  return /* @__PURE__ */ jsx44(exports_dist5.Trigger, {
    "data-slot": "alert-dialog-trigger",
    ...props
  });
}
function AlertDialogPortal2({ ...props }) {
  return /* @__PURE__ */ jsx44(exports_dist5.Portal, {
    "data-slot": "alert-dialog-portal",
    ...props
  });
}
function AlertDialogOverlay2({ className, ...props }) {
  return /* @__PURE__ */ jsx44(exports_dist5.Overlay, {
...
function AlertDialogContent2({ className, ...props }) {
  return /* @__PURE__ */ jsxs23(AlertDialogPortal2, {
    children: [
      /* @__PURE__ */ jsx44(AlertDialogOverlay2, {}),
      /* @__PURE__ */ jsx44(exports_dist5.Content, {
        "data-slot": "alert-dialog-content",
        className: clsx33("data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border bg-background p-6 shadow-lg duration-200 data-[state=closed]:animate-out data-[state=open]:animate-in sm:max-w-lg", className),
        ...props
      })
    ]
  });
...
function AlertDialogHeader({ className, ...props }) {
  return /* @__PURE__ */ jsx44("div", {
    ...
    className: clsx33("flex flex-col gap-2 text-center sm:text-left", className),
    ...props
  });
}
function AlertDialogFooter({ className, ...props }) {
  return /* @__PURE__ */ jsx44("div", {
    ...
    className: clsx33("flex flex-col-reverse gap-2 sm:flex-row sm:justify-end", className),
    ...props
  });
}
function AlertDialogTitle2({ className, ...props }) {
  return /* @__PURE__ */ jsx44(exports_dist5.Title, {
    "data-slot": "alert-dialog-title",
    className: clsx33("font-semibold text-lg", className),
    ...props
  });
}
function AlertDialogDescription2({ className, ...props }) {
  return /* @__PURE__ */ jsx44(exports_dist5.Description, {
...
function AlertDialogAction2({ className, ...props }) {
  return /* @__PURE__ */ jsx44(exports_dist5.Action, {
    className: clsx33(buttonVariants2(), className),
    ...props
  });
}
function AlertDialogCancel2({ className, ...props }) {
  return /* @__PURE__ */ jsx44(exports_dist5.Cancel, {
    className: clsx33(buttonVariants2({ variant: "outline" }), className),
    ...props
  });
}
...
function Alert({ className, variant, ...props }) {
  return /* @__PURE__ */ jsx52("div", {
    "data-slot": "alert",
    role: "alert",
    className: clsx42(alertVariants({ variant }), className),
    ...props
  });
}
function AlertTitle({ className, ...props }) {
  return /* @__PURE__ */ jsx52("div", {
    ...
    className: clsx42("col-start-2 line-clamp-1 min-h-4 font-medium tracking-tight", className),
    ...props
  });
}
function AlertDescription({ className, ...props }) {
  return /* @__PURE__ */ jsx52("div", {
    ...
    className: clsx42("col-start-2 grid justify-items-start gap-1 text-muted-foreground text-sm [&_p]:leading-relaxed", className),
    ...props
  });
}
function Avatar2({ className, ...props }) {
  return /* @__PURE__ */ jsx73(exports_dist6.Root, {
    "data-slot": "avatar",
    className: clsx53("relative flex size-8 shrink-0 overflow-hidden rounded-full", className),
    ...props
  });
}
function AvatarImage2({ className, ...props }) {
  return /* @__PURE__ */ jsx73(exports_dist6.Image, {
    "data-slot": "avatar-image",
    className: clsx53("aspect-square size-full", className),
    ...props
  });
}
function AvatarFallback2({ className, ...props }) {
  return /* @__PURE__ */ jsx73(exports_dist6.Fallback, {
    "data-slot": "avatar-fallback",
    className: clsx53("flex size-full items-center justify-center rounded-full bg-muted", className),
    ...props
  });
}
...
function Badge({ className, variant, asChild = false, ...props }) {
  ...
  return /* @__PURE__ */ jsx83(Comp, {
    "data-slot": "badge",
    className: clsx62(badgeVariants({ variant }), className),
    ...props
  });
}
function Breadcrumb({ ...props }) {
  return /* @__PURE__ */ jsx93("nav", {
...
function BreadcrumbList({ className, ...props }) {
  return /* @__PURE__ */ jsx93("ol", {
    "data-slot": "breadcrumb-list",
    className: clsx72("flex flex-wrap items-center gap-1.5 break-words text-muted-foreground text-sm sm:gap-2.5", className),
    ...props
  });
}
function BreadcrumbItem({ className, ...props }) {
  return /* @__PURE__ */ jsx93("li", {
    "data-slot": "breadcrumb-item",
    className: clsx72("inline-flex items-center gap-1.5", className),
    ...props
  });
}
function BreadcrumbLink({ asChild, className, ...props }) {
  const Comp = asChild ? exports_dist.Slot : "a";
  return /* @__PURE__ */ jsx93(Comp, {
    "data-slot": "breadcrumb-link",
    className: clsx72("transition-colors hover:text-foreground", className),
    ...props
  });
}
function BreadcrumbPage({ className, ...props }) {
  return /* @__PURE__ */ jsx93("span", {
    "data-slot": "breadcrumb-page",
    role: "link",
    "aria-disabled": "true",
    "aria-current": "page",
    className: clsx72("font-normal text-foreground", className),
    ...props
  });
}
function BreadcrumbSeparator({ children, className, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsx93("li", {
    ...
    role: "presentation",
    "aria-hidden": "true",
    className: clsx72("[&>svg]:size-3.5", className),
    ...props,
    children: children ?? /* @__PURE__ */ jsx93(SpriteIcon3, {
      id: "ChevronRight",
      url: spriteUrl
    })
  });
...
function BreadcrumbEllipsis({ className, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs33("span", {
    "data-slot": "breadcrumb-ellipsis",
    role: "presentation",
    "aria-hidden": "true",
    className: clsx72("flex size-9 items-center justify-center", className),
    ...props,
    children: [
      /* @__PURE__ */ jsx93(SpriteIcon3, {
        id: "Ellipsis",
        className: "size-4",
        url: spriteUrl
      }),
...
function Card({ className, ...props }) {
  return /* @__PURE__ */ jsx102("div", {
    "data-slot": "card",
    className: clsx82("flex flex-col gap-6 rounded-xl border bg-card py-6 text-card-foreground shadow-sm", className),
    ...props
  });
}
function CardHeader({ className, ...props }) {
  return /* @__PURE__ */ jsx102("div", {
    ...
    className: clsx82("@container/card-header grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 px-6 has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-6", className),
    ...props
  });
}
function CardTitle({ className, ...props }) {
  return /* @__PURE__ */ jsx102("div", {
    ...
    className: clsx82("font-semibold leading-none", className),
    ...props
  });
}
function CardDescription({ className, ...props }) {
  return /* @__PURE__ */ jsx102("div", {
    ...
    className: clsx82("text-muted-foreground text-sm", className),
    ...props
  });
}
function CardAction({ className, ...props }) {
  return /* @__PURE__ */ jsx102("div", {
    ...
    className: clsx82("col-start-2 row-span-2 row-start-1 self-start justify-self-end", className),
    ...props
  });
}
function CardContent({ className, ...props }) {
  return /* @__PURE__ */ jsx102("div", {
    ...
    className: clsx82("px-6", className),
    ...props
  });
}
function CardFooter({ className, ...props }) {
  return /* @__PURE__ */ jsx102("div", {
    ...
    className: clsx82("flex items-center px-6 [.border-t]:pt-6", className),
    ...props
  });
}
function Collapsible2({ ...props }) {
  return /* @__PURE__ */ jsx122(exports_dist2.Root, {
    "data-slot": "collapsible",
    ...props
  });
}
function CollapsibleTrigger2({ ...props }) {
  return /* @__PURE__ */ jsx122(exports_dist2.CollapsibleTrigger, {
    "data-slot": "collapsible-trigger",
    ...props
  });
}
function CollapsibleContent2({ ...props }) {
  return /* @__PURE__ */ jsx122(exports_dist2.CollapsibleContent, {
    "data-slot": "collapsible-content",
    ...props
  });
}
function Dialog2({ ...props }) {
  return /* @__PURE__ */ jsx132(exports_dist4.Root, {
    "data-slot": "dialog",
    ...props
  });
}
function DialogTrigger2({ ...props }) {
  return /* @__PURE__ */ jsx132(exports_dist4.Trigger, {
    "data-slot": "dialog-trigger",
    ...props
  });
}
function DialogPortal2({ ...props }) {
  return /* @__PURE__ */ jsx132(exports_dist4.Portal, {
    "data-slot": "dialog-portal",
    ...props
  });
}
function DialogClose2({ ...props }) {
  return /* @__PURE__ */ jsx132(exports_dist4.Close, {
    "data-slot": "dialog-close",
    ...props
  });
}
function DialogOverlay2({ className, ...props }) {
  return /* @__PURE__ */ jsx132(exports_dist4.Overlay, {
...
function DialogContent2({ className, children, showCloseButton = true, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs42(DialogPortal2, {
    "data-slot": "dialog-portal",
    children: [
      /* @__PURE__ */ jsx132(DialogOverlay2, {}),
      /* @__PURE__ */ jsxs42(exports_dist4.Content, {
        ...
        children: [
          children,
          showCloseButton && /* @__PURE__ */ jsxs42(exports_dist4.Close, {
            "data-slot": "dialog-close",
            className: "absolute top-4 right-4 rounded-xs opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
            children: [
              /* @__PURE__ */ jsx132(SpriteIcon3, {
                id: "X",
                url: spriteUrl
              }),
...
function DialogTitle2({ className, ...props }) {
  return /* @__PURE__ */ jsx132(exports_dist4.Title, {
...
function DialogDescription2({ className, ...props }) {
  return /* @__PURE__ */ jsx132(exports_dist4.Description, {
...
function CommandDialog({
  ...
  return /* @__PURE__ */ jsxs52(Dialog2, {
    ...props,
    children: [
      /* @__PURE__ */ jsxs52(DialogHeader, {
        className: "sr-only",
        children: [
          /* @__PURE__ */ jsx142(DialogTitle2, {
            children: title
          }),
          /* @__PURE__ */ jsx142(DialogDescription2, {
            children: description
          })
        ]
      }),
      /* @__PURE__ */ jsx142(DialogContent2, {
        spriteUrl,
        className: clsx11("overflow-hidden p-0", className),
        showCloseButton,
        children: /* @__PURE__ */ jsx142(Command, {
...
function CommandInput({ className, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs52("div", {
    ...
    children: [
      /* @__PURE__ */ jsx142(SpriteIcon3, {
        id: "Search",
        url: spriteUrl,
        className: "size-4 shrink-0 opacity-50"
      }),
      /* @__PURE__ */ jsx142(_e.Input, {
...
function CommandList({ className, ...props }) {
  return /* @__PURE__ */ jsx142(_e.List, {
...
function CommandEmpty({ ...props }) {
  return /* @__PURE__ */ jsx142(_e.Empty, {
...
function CommandGroup({ className, ...props }) {
  return /* @__PURE__ */ jsx142(_e.Group, {
...
function CommandSeparator({ className, ...props }) {
  return /* @__PURE__ */ jsx142(_e.Separator, {
...
function CommandItem({ className, ...props }) {
  return /* @__PURE__ */ jsx142(_e.Item, {
...
function ContextMenu2({ ...props }) {
  return /* @__PURE__ */ jsx152(exports_dist10.Root, {
    "data-slot": "context-menu",
    ...props
  });
}
function ContextMenuTrigger2({ ...props }) {
  return /* @__PURE__ */ jsx152(exports_dist10.Trigger, {
    "data-slot": "context-menu-trigger",
    ...props
  });
}
function ContextMenuGroup2({ ...props }) {
  return /* @__PURE__ */ jsx152(exports_dist10.Group, {
    "data-slot": "context-menu-group",
    ...props
  });
}
function ContextMenuPortal2({ ...props }) {
  return /* @__PURE__ */ jsx152(exports_dist10.Portal, {
    "data-slot": "context-menu-portal",
    ...props
  });
}
function ContextMenuSub2({ ...props }) {
  return /* @__PURE__ */ jsx152(exports_dist10.Sub, {
    "data-slot": "context-menu-sub",
    ...props
  });
}
function ContextMenuRadioGroup2({ ...props }) {
  return /* @__PURE__ */ jsx152(exports_dist10.RadioGroup, {
    "data-slot": "context-menu-radio-group",
    ...props
  });
}
function ContextMenuSubTrigger2({ className, inset, children, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs62(exports_dist10.SubTrigger, {
...
function ContextMenuSubContent2({ className, ...props }) {
  return /* @__PURE__ */ jsx152(exports_dist10.SubContent, {
...
function ContextMenuContent2({ className, ...props }) {
  return /* @__PURE__ */ jsx152(exports_dist10.Portal, {
    children: /* @__PURE__ */ jsx152(exports_dist10.Content, {
...
function ContextMenuItem2({ className, inset, variant = "default", ...props }) {
  return /* @__PURE__ */ jsx152(exports_dist10.Item, {
...
function ContextMenuCheckboxItem2({ className, children, checked, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs62(exports_dist10.CheckboxItem, {
    ...
    children: [
      /* @__PURE__ */ jsx152("span", {
        ...
        children: /* @__PURE__ */ jsx152(exports_dist10.ItemIndicator, {
          children: /* @__PURE__ */ jsx152(SpriteIcon3, {
            id: "Check",
            className: "size-4",
            url: spriteUrl
          })
...
function ContextMenuRadioItem2({ className, children, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs62(exports_dist10.RadioItem, {
...
function ContextMenuLabel2({ className, inset, ...props }) {
  return /* @__PURE__ */ jsx152(exports_dist10.Label, {
...
function ContextMenuSeparator2({ className, ...props }) {
  return /* @__PURE__ */ jsx152(exports_dist10.Separator, {
...
function DropdownMenu2({ ...props }) {
  return /* @__PURE__ */ jsx162(exports_dist12.Root, {
    "data-slot": "dropdown-menu",
    ...props
  });
}
function DropdownMenuPortal2({ ...props }) {
  return /* @__PURE__ */ jsx162(exports_dist12.Portal, {
    "data-slot": "dropdown-menu-portal",
    ...props
  });
}
function DropdownMenuTrigger2({ ...props }) {
  return /* @__PURE__ */ jsx162(exports_dist12.Trigger, {
...
function DropdownMenuContent2({ className, sideOffset = 4, ...props }) {
  return /* @__PURE__ */ jsx162(exports_dist12.Portal, {
    children: /* @__PURE__ */ jsx162(exports_dist12.Content, {
...
function DropdownMenuGroup2({ ...props }) {
  return /* @__PURE__ */ jsx162(exports_dist12.Group, {
    "data-slot": "dropdown-menu-group",
    ...props
  });
}
function DropdownMenuItem2({ className, inset, variant = "default", ...props }) {
  return /* @__PURE__ */ jsx162(exports_dist12.Item, {
...
function DropdownMenuCheckboxItem2({ className, children, checked, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs72(exports_dist12.CheckboxItem, {
    ...
    children: [
      /* @__PURE__ */ jsx162("span", {
        className: "pointer-events-none absolute left-2 flex size-3.5 items-center justify-center",
        children: /* @__PURE__ */ jsx162(exports_dist12.ItemIndicator, {
          children: /* @__PURE__ */ jsx162(SpriteIcon3, {
            id: "Check",
            className: "size-4",
            url: spriteUrl
          })
...
function DropdownMenuRadioGroup2({ ...props }) {
  return /* @__PURE__ */ jsx162(exports_dist12.RadioGroup, {
    "data-slot": "dropdown-menu-radio-group",
    ...props
  });
}
function DropdownMenuRadioItem2({ className, children, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs72(exports_dist12.RadioItem, {
...
function DropdownMenuLabel2({ className, inset, ...props }) {
  return /* @__PURE__ */ jsx162(exports_dist12.Label, {
...
function DropdownMenuSeparator2({ className, ...props }) {
  return /* @__PURE__ */ jsx162(exports_dist12.Separator, {
...
function DropdownMenuSub2({ ...props }) {
  return /* @__PURE__ */ jsx162(exports_dist12.Sub, {
    "data-slot": "dropdown-menu-sub",
    ...props
  });
}
function DropdownMenuSubTrigger2({ className, inset, children, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs72(exports_dist12.SubTrigger, {
...
function DropdownMenuSubContent2({ className, ...props }) {
  return /* @__PURE__ */ jsx162(exports_dist12.SubContent, {
...
function HoverCard2({ ...props }) {
  return /* @__PURE__ */ jsx172(exports_dist14.Root, {
    "data-slot": "hover-card",
    ...props
  });
}
function HoverCardTrigger2({ ...props }) {
  return /* @__PURE__ */ jsx172(exports_dist14.Trigger, {
    "data-slot": "hover-card-trigger",
    ...props
  });
}
function HoverCardContent2({ className, align = "center", sideOffset = 4, ...props }) {
  return /* @__PURE__ */ jsx172(exports_dist14.Portal, {
    "data-slot": "hover-card-portal",
    children: /* @__PURE__ */ jsx172(exports_dist14.Content, {
...
function Label6({ className, ...props }) {
  return /* @__PURE__ */ jsx192(exports_dist13.Root, {
    "data-slot": "label",
...
function Menubar2({ className, ...props }) {
  return /* @__PURE__ */ jsx202(exports_dist15.Root, {
    "data-slot": "menubar",
...
function MenubarMenu2({ ...props }) {
  return /* @__PURE__ */ jsx202(exports_dist15.Menu, {
    "data-slot": "menubar-menu",
    ...props
  });
}
function MenubarGroup2({ ...props }) {
  return /* @__PURE__ */ jsx202(exports_dist15.Group, {
    "data-slot": "menubar-group",
    ...props
  });
}
function MenubarPortal2({ ...props }) {
  return /* @__PURE__ */ jsx202(exports_dist15.Portal, {
    "data-slot": "menubar-portal",
    ...props
  });
}
function MenubarRadioGroup2({ ...props }) {
  return /* @__PURE__ */ jsx202(exports_dist15.RadioGroup, {
    "data-slot": "menubar-radio-group",
    ...props
  });
}
function MenubarTrigger2({ className, ...props }) {
  return /* @__PURE__ */ jsx202(exports_dist15.Trigger, {
...
function MenubarContent2({ className, align = "start", alignOffset = -4, sideOffset = 8, ...props }) {
  return /* @__PURE__ */ jsx202(MenubarPortal2, {
    children: /* @__PURE__ */ jsx202(exports_dist15.Content, {
...
function MenubarItem2({
  ...
  return /* @__PURE__ */ jsx202(exports_dist15.Item, {
...
function MenubarCheckboxItem2({ className, children, checked, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs82(exports_dist15.CheckboxItem, {
    ...
    children: [
      /* @__PURE__ */ jsx202("span", {
        className: "pointer-events-none absolute left-2 flex size-3.5 items-center justify-center",
        children: /* @__PURE__ */ jsx202(exports_dist15.ItemIndicator, {
          children: /* @__PURE__ */ jsx202(SpriteIcon3, {
            id: "Check",
            className: "size-4",
            url: spriteUrl
          })
...
function MenubarRadioItem2({ className, children, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs82(exports_dist15.RadioItem, {
...
function MenubarLabel2({
  ...
  return /* @__PURE__ */ jsx202(exports_dist15.Label, {
...
function MenubarSeparator2({ className, ...props }) {
  return /* @__PURE__ */ jsx202(exports_dist15.Separator, {
...
function MenubarSub2({ ...props }) {
  return /* @__PURE__ */ jsx202(exports_dist15.Sub, {
    "data-slot": "menubar-sub",
    ...props
  });
}
function MenubarSubTrigger2({ className, inset, children, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs82(exports_dist15.SubTrigger, {
...
function MenubarSubContent2({ className, ...props }) {
  return /* @__PURE__ */ jsx202(exports_dist15.SubContent, {
...
function NavigationMenu2({ className, children, viewport = true, ...props }) {
  return /* @__PURE__ */ jsxs92(exports_dist16.Root, {
    ...
    children: [
      children,
      viewport && /* @__PURE__ */ jsx213(NavigationMenuViewport2, {})
    ]
  });
}
function NavigationMenuList2({ className, ...props }) {
  return /* @__PURE__ */ jsx213(exports_dist16.List, {
...
function NavigationMenuItem2({ className, ...props }) {
  return /* @__PURE__ */ jsx213(exports_dist16.Item, {
...
function NavigationMenuTrigger2({ className, children, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs92(exports_dist16.Trigger, {
...
function NavigationMenuContent2({ className, ...props }) {
  return /* @__PURE__ */ jsx213(exports_dist16.Content, {
...
function NavigationMenuViewport2({ className, ...props }) {
  return /* @__PURE__ */ jsx213("div", {
    className: clsx18("absolute top-full left-0 isolate z-50 flex justify-center"),
    children: /* @__PURE__ */ jsx213(exports_dist16.Viewport, {
...
function NavigationMenuLink2({ className, ...props }) {
  return /* @__PURE__ */ jsx213(exports_dist16.Link, {
...
function NavigationMenuIndicator2({ className, ...props }) {
  return /* @__PURE__ */ jsx213(exports_dist16.Indicator, {
...
function PaginationPrevious({ className, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs102(PaginationLink, {
    "aria-label": "Go to previous page",
    size: "default",
    className: clsx19("gap-1 px-2.5 sm:pl-2.5", className),
    ...props,
    children: [
      /* @__PURE__ */ jsx222(SpriteIcon3, {
        id: "ChevronLeft",
        url: spriteUrl
      }),
      /* @__PURE__ */ jsx222("span", {
...
function Popover2({ ...props }) {
  return /* @__PURE__ */ jsx232(exports_dist18.Root, {
    "data-slot": "popover",
    ...props
  });
}
function PopoverTrigger2({ ...props }) {
  return /* @__PURE__ */ jsx232(exports_dist18.Trigger, {
    "data-slot": "popover-trigger",
    ...props
  });
}
function PopoverContent2({ className, align = "center", sideOffset = 4, ...props }) {
  return /* @__PURE__ */ jsx232(exports_dist18.Portal, {
    children: /* @__PURE__ */ jsx232(exports_dist18.Content, {
...
function PopoverAnchor2({ ...props }) {
  return /* @__PURE__ */ jsx232(exports_dist18.Anchor, {
    "data-slot": "popover-anchor",
    ...props
  });
}
function RadioGroup5({ className, ...props }) {
  return /* @__PURE__ */ jsx252(exports_dist19.Root, {
    "data-slot": "radio-group",
    className: clsx222("grid gap-3", className),
    ...props
  });
}
function RadioGroupItem2({ className, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsx252(exports_dist19.Item, {
    "data-slot": "radio-group-item",
    className: clsx222("aspect-square size-4 shrink-0 rounded-full border border-input text-primary shadow-xs outline-none transition-[color,box-shadow] focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:bg-input/30 dark:aria-invalid:ring-destructive/40", className),
    ...props,
    children: /* @__PURE__ */ jsx252(exports_dist19.Indicator, {
      "data-slot": "radio-group-indicator",
      className: "relative flex items-center justify-center",
      children: /* @__PURE__ */ jsx252(SpriteIcon3, {
        id: "Circle",
        url: spriteUrl,
...
function ScrollArea2({ className, children, ...props }) {
  return /* @__PURE__ */ jsxs11(exports_dist20.Root, {
    "data-slot": "scroll-area",
    className: clsx232("relative", className),
    ...props,
    children: [
      /* @__PURE__ */ jsx262(exports_dist20.Viewport, {
        "data-slot": "scroll-area-viewport",
        className: "size-full rounded-[inherit] outline-none transition-[color,box-shadow] focus-visible:outline-1 focus-visible:ring-[3px] focus-visible:ring-ring/50",
        children
      }),
      /* @__PURE__ */ jsx262(ScrollBar, {}),
      /* @__PURE__ */ jsx262(exports_dist20.Corner, {})
    ]
  });
}
function ScrollBar({ className, orientation = "vertical", ...props }) {
  return /* @__PURE__ */ jsx262(exports_dist20.ScrollAreaScrollbar, {
    "data-slot": "scroll-area-scrollbar",
    orientation,
    className: clsx232("flex touch-none select-none p-px transition-colors", orientation === "vertical" && "h-full w-2.5 border-l border-l-transparent", orientation === "horizontal" && "h-2.5 flex-col border-t border-t-transparent", className),
    ...props,
    children: /* @__PURE__ */ jsx262(exports_dist20.ScrollAreaThumb, {
...
function Select2({ ...props }) {
  return /* @__PURE__ */ jsx272(exports_dist21.Root, {
    "data-slot": "select",
    ...props
  });
}
function SelectGroup2({ ...props }) {
  return /* @__PURE__ */ jsx272(exports_dist21.Group, {
    "data-slot": "select-group",
    ...props
  });
}
function SelectValue2({ ...props }) {
  return /* @__PURE__ */ jsx272(exports_dist21.Value, {
    "data-slot": "select-value",
    ...props
  });
}
function SelectTrigger2({ className, size: size4 = "default", children, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs12(exports_dist21.Trigger, {
    ...
    children: [
      children,
      /* @__PURE__ */ jsx272(exports_dist21.Icon, {
        asChild: true,
        children: /* @__PURE__ */ jsx272(SpriteIcon3, {
          id: "ChevronDown",
...
function SelectContent2({ className, children, position = "popper", spriteUrl, ...props }) {
  return /* @__PURE__ */ jsx272(exports_dist21.Portal, {
    children: /* @__PURE__ */ jsxs12(exports_dist21.Content, {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx272(SelectScrollUpButton2, {
          spriteUrl
        }),
        /* @__PURE__ */ jsx272(exports_dist21.Viewport, {
        ...
        /* @__PURE__ */ jsx272(SelectScrollDownButton2, {
          spriteUrl
        })
      ]
    })
...
function SelectLabel2({ className, ...props }) {
  return /* @__PURE__ */ jsx272(exports_dist21.Label, {
    "data-slot": "select-label",
    className: clsx24("px-2 py-1.5 text-muted-foreground text-xs", className),
    ...props
  });
}
function SelectItem2({ className, spriteUrl, children, ...props }) {
  return /* @__PURE__ */ jsxs12(exports_dist21.Item, {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx272("span", {
        className: "absolute right-2 flex size-3.5 items-center justify-center",
        children: /* @__PURE__ */ jsx272(exports_dist21.ItemIndicator, {
          children: /* @__PURE__ */ jsx272(SpriteIcon3, {
            id: "Check",
            className: "size-4",
            url: spriteUrl
      ...
      /* @__PURE__ */ jsx272(exports_dist21.ItemText, {
        children
      })
    ]
  });
...
function SelectSeparator2({ className, ...props }) {
  return /* @__PURE__ */ jsx272(exports_dist21.Separator, {
    "data-slot": "select-separator",
    className: clsx24("-mx-1 pointer-events-none my-1 h-px bg-border", className),
    ...props
  });
}
function SelectScrollUpButton2({ className, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsx272(exports_dist21.ScrollUpButton, {
...
function SelectScrollDownButton2({ className, spriteUrl, ...props }) {
  return /* @__PURE__ */ jsx272(exports_dist21.ScrollDownButton, {
...
function Separator6({ className, orientation = "horizontal", decorative = true, ...props }) {
  return /* @__PURE__ */ jsx282(exports_dist22.Root, {
    "data-slot": "separator",
    decorative,
    orientation,
...
function Sheet({ ...props }) {
  return /* @__PURE__ */ jsx292(exports_dist4.Root, {
    "data-slot": "sheet",
    ...props
  });
}
function SheetTrigger({ ...props }) {
  return /* @__PURE__ */ jsx292(exports_dist4.Trigger, {
    "data-slot": "sheet-trigger",
    ...props
  });
}
function SheetClose({ ...props }) {
  return /* @__PURE__ */ jsx292(exports_dist4.Close, {
    "data-slot": "sheet-close",
    ...props
  });
}
function SheetPortal({ ...props }) {
  return /* @__PURE__ */ jsx292(exports_dist4.Portal, {
    "data-slot": "sheet-portal",
    ...props
  });
}
function SheetOverlay({ className, ...props }) {
  return /* @__PURE__ */ jsx292(exports_dist4.Overlay, {
...
function SheetContent({ className, children, side = "right", spriteUrl, ...props }) {
  return /* @__PURE__ */ jsxs13(SheetPortal, {
    children: [
      /* @__PURE__ */ jsx292(SheetOverlay, {}),
      /* @__PURE__ */ jsxs13(exports_dist4.Content, {
        ...
        children: [
          children,
          /* @__PURE__ */ jsxs13(exports_dist4.Close, {
...
function SheetTitle({ className, ...props }) {
  return /* @__PURE__ */ jsx292(exports_dist4.Title, {
...
function SheetDescription({ className, ...props }) {
  return /* @__PURE__ */ jsx292(exports_dist4.Description, {
...
function useIsMobile() {
  const [isMobile, setIsMobile] = React62.useState(undefined);
  React62.useEffect(() => {
...
function TooltipProvider2({ delayDuration = 0, ...props }) {
  return /* @__PURE__ */ jsx313(exports_dist26.Provider, {
...
function Tooltip2({ ...props }) {
  return /* @__PURE__ */ jsx313(TooltipProvider2, {
    children: /* @__PURE__ */ jsx313(exports_dist26.Root, {
      "data-slot": "tooltip",
      ...props
    })
  });
...
function TooltipTrigger2({ ...props }) {
  return /* @__PURE__ */ jsx313(exports_dist26.Trigger, {
    "data-slot": "tooltip-trigger",
    ...props
  });
}
function TooltipContent2({ className, sideOffset = 0, children, ...props }) {
  return /* @__PURE__ */ jsx313(exports_dist26.Portal, {
    children: /* @__PURE__ */ jsxs14(exports_dist26.Content, {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx313(exports_dist26.Arrow, {
...
var SidebarContext = React212.createContext(null);
function useSidebar() {
  const context = React212.useContext(SidebarContext);
  if (!context) {
...
function SidebarProvider({
  ...
  const [openMobile, setOpenMobile] = React212.useState(false);
  const [_open, _setOpen] = React212.useState(defaultOpen);
  const open = openProp ?? _open;
  const setOpen = React212.useCallback((value) => {
  ...
  const toggleSidebar = React212.useCallback(() => {
  ...
  return /* @__PURE__ */ jsx322(SidebarContext.Provider, {
    value: contextValue,
    children: /* @__PURE__ */ jsx322(TooltipProvider2, {
      delayDuration: 0,
      children: /* @__PURE__ */ jsx322("div", {
      ...
      children: /* @__PURE__ */ jsxs15(SheetContent, {
        ...
        children: [
          /* @__PURE__ */ jsxs15(SheetHeader, {
            className: "sr-only",
            children: [
              /* @__PURE__ */ jsx322(SheetTitle, {
                children: "Sidebar"
              }),
              /* @__PURE__ */ jsx322(SheetDescription, {
...
function SidebarTrigger({ className, onClick, spriteUrl, ...props }) {
  ...
  return /* @__PURE__ */ jsxs15(Button, {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx322(SpriteIcon3, {
        id: "PanelLeft",
        url: spriteUrl
      }),
      /* @__PURE__ */ jsx322("span", {
        className: "sr-only",
...
function SidebarSeparator({ className, ...props }) {
  return /* @__PURE__ */ jsx322(Separator6, {
...
function SidebarMenuButton({
  ...
  const button = /* @__PURE__ */ jsx322(Comp, {
    "data-slot": "sidebar-menu-button",
    "data-sidebar": "menu-button",
    "data-size": size4,
    "data-active": isActive,
    className: clsx29(sidebarMenuButtonVariants({ variant, size: size4 }), className),
    ...props
  });
  if (!tooltip) {
    return button;
  ...
  return /* @__PURE__ */ jsxs15(Tooltip2, {
    children: [
      /* @__PURE__ */ jsx322(TooltipTrigger2, {
        asChild: true,
        children: button
      }),
      /* @__PURE__ */ jsx322(TooltipContent2, {
        side: "right",
        align: "center",
...
function SidebarMenuSkeleton({
  ...
  return /* @__PURE__ */ jsxs15("div", {
    ...
    ...props,
    children: [
      showIcon && /* @__PURE__ */ jsx322(Skeleton, {
        className: "size-4 rounded-md",
        "data-sidebar": "menu-skeleton-icon"
      }),
      /* @__PURE__ */ jsx322(Skeleton, {
...
function Table({ className, ...props }) {
  return /* @__PURE__ */ jsx362("div", {
    "data-slot": "table-container",
    className: "relative w-full overflow-x-auto",
    children: /* @__PURE__ */ jsx362("table", {
      "data-slot": "table",
      className: clsx322("w-full caption-bottom text-sm", className),
      ...props
    })
  });
}
function TableHeader({ className, ...props }) {
  return /* @__PURE__ */ jsx362("thead", {
    "data-slot": "table-header",
    className: clsx322("[&_tr]:border-b", className),
    ...props
  });
}
function TableBody({ className, ...props }) {
  return /* @__PURE__ */ jsx362("tbody", {
    "data-slot": "table-body",
    className: clsx322("[&_tr:last-child]:border-0", className),
    ...props
  });
}
function TableFooter({ className, ...props }) {
  return /* @__PURE__ */ jsx362("tfoot", {
    "data-slot": "table-footer",
    className: clsx322("border-t bg-muted/50 font-medium [&>tr]:last:border-b-0", className),
    ...props
  });
}
function TableRow({ className, ...props }) {
  return /* @__PURE__ */ jsx362("tr", {
    "data-slot": "table-row",
    className: clsx322("border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted", className),
    ...props
  });
}
function TableHead({ className, ...props }) {
  return /* @__PURE__ */ jsx362("th", {
    "data-slot": "table-head",
    className: clsx322("h-10 whitespace-nowrap px-2 text-left align-middle font-medium text-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]", className),
    ...props
  });
}
function TableCell({ className, ...props }) {
  return /* @__PURE__ */ jsx362("td", {
    "data-slot": "table-cell",
    className: clsx322("whitespace-nowrap p-2 align-middle [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]", className),
    ...props
  });
}
function TableCaption({ className, ...props }) {
  return /* @__PURE__ */ jsx362("caption", {
    "data-slot": "table-caption",
    className: clsx322("mt-4 text-muted-foreground text-sm", className),
    ...props
  });
}
function Tabs2({ className, ...props }) {
  return /* @__PURE__ */ jsx372(exports_dist23.Root, {
    "data-slot": "tabs",
    className: clsx332("flex flex-col gap-2", className),
    ...props
  });
}
function TabsList2({ className, ...props }) {
  return /* @__PURE__ */ jsx372(exports_dist23.List, {
    "data-slot": "tabs-list",
    className: clsx332("inline-flex h-9 w-fit items-center justify-center rounded-lg bg-muted p-[3px] text-muted-foreground", className),
    ...props
  });
}
function TabsTrigger2({ className, ...props }) {
  return /* @__PURE__ */ jsx372(exports_dist23.Trigger, {
    "data-slot": "tabs-trigger",
    className: clsx332("inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-md border border-transparent px-2 py-1 font-medium text-foreground text-sm transition-[color,box-shadow] focus-visible:border-ring focus-visible:outline-1 focus-visible:outline-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:shadow-sm dark:text-muted-foreground dark:data-[state=active]:border-input dark:data-[state=active]:bg-input/30 dark:data-[state=active]:text-foreground [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0", className),
    ...props
  });
}
function TabsContent2({ className, ...props }) {
  return /* @__PURE__ */ jsx372(exports_dist23.Content, {
    "data-slot": "tabs-content",
    className: clsx332("flex-1 outline-none", className),
    ...props
  });
}
...
function Toggle2({ className, variant, size: size4, ...props }) {
  return /* @__PURE__ */ jsx392(exports_dist24.Root, {
    "data-slot": "toggle",
    className: clsx35(toggleVariants({ variant, size: size4, className })),
    ...props
  });
}
var ToggleGroupContext2 = React410.createContext({
  size: "default",
  variant: "default"
});
function ToggleGroup2({ className, variant, size: size4, children, ...props }) {
  return /* @__PURE__ */ jsx402(exports_dist25.Root, {
    "data-slot": "toggle-group",
    "data-variant": variant,
    "data-size": size4,
    className: clsx36("group/toggle-group flex w-fit items-center rounded-md data-[variant=outline]:shadow-xs", className),
    ...props,
    children: /* @__PURE__ */ jsx402(ToggleGroupContext2.Provider, {
...
function ToggleGroupItem2({ className, children, variant, size: size4, ...props }) {
  const context = React410.useContext(ToggleGroupContext2);
  return /* @__PURE__ */ jsx402(exports_dist25.Item, {
...
var Form = RouterForm;
var FormFieldContext = React510.createContext({});
var FormField = ({ name, children }) => {
  return /* @__PURE__ */ jsx412(FormFieldContext.Provider, {
    value: { name },
    children
  });
};
var useFormField = () => {
  const fieldContext = React510.useContext(FormFieldContext);
  const itemContext = React510.useContext(FormItemContext);
  if (!fieldContext) {
...
var FormItemContext = React510.createContext({});
function FormItem({ className, ...props }) {
  const id = React510.useId();
  return /* @__PURE__ */ jsx412(FormItemContext.Provider, {
    value: { id },
    children: /* @__PURE__ */ jsx412("div", {
      "data-slot": "form-item",
...
function FormControl({ ...props }) {
  ...
  return /* @__PURE__ */ jsx412(exports_dist.Slot, {
...
var Link3 = React63.forwardRef(function Link23(props, ref) {
  return /* @__PURE__ */ jsx422(RouterLink2, {
    ...props,
    to: props.href,
    ref
  });
      ...
      children: [
          ...
          children: /* @__PURE__ */ jsxs17("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx45("nav", {
                ...
                children: docs.length === 0 ? /* @__PURE__ */ jsx45(DocListEmpty, {}) : /* @__PURE__ */ jsx45(DocList, {
                  docs,
                  selectedDoc,
              ...
              /* @__PURE__ */ jsxs17("div", {
                ...
                children: [
                  ...
                  !mounted ? /* @__PURE__ */ jsx45("div", {
                    className: "size-5"
                  }) : /* @__PURE__ */ jsx45(ThemeSwitch, {
                    spriteUrl,
                    children: themeContext ? ({ theme }) => /* @__PURE__ */ jsx45("button", {
                      type: "button",
                      ...
                      children: themeContext.resolvedTheme === theme.theme.dark ? /* @__PURE__ */ jsx45(SpriteIcon, {
                        url: spriteUrl,
                        id: "Moon",
                        className: "size-5"
        ...
        /* @__PURE__ */ jsx45("main", {
          ...
          children: /* @__PURE__ */ jsx45("div", {
            ...
            }) : /* @__PURE__ */ jsx45(DocumentNotFound, {
              spriteUrl
            })
          })
        })
...
var DocList = memo4(({ docs, selectedDoc, onDocSelect, spriteUrl }) => {
  ...
  return /* @__PURE__ */ jsx45("div", {
    ...
    children: Object.entries(groups).map(([folder, folderDocs]) => {
      ...
      return /* @__PURE__ */ jsxs17("div", {
        children: [
          !isRootLevel && /* @__PURE__ */ jsxs17("div", {
            className: "relative",
            children: [
              ...
              /* @__PURE__ */ jsx45("div", {
                ...
                children: folderDocs.map((doc) => /* @__PURE__ */ jsx45("button", {
                  type: "button",
                  onClick: () => onDocSelect(doc.slug),
                  className: clsx39("w-full px-3 py-2 text-left text-sm transition-colors focus:outline-none", selectedDoc === doc.slug ? "border-blue-500 border-r-2 bg-blue-50 text-blue-900 dark:border-blue-400 dark:bg-blue-900/20 dark:text-blue-100" : "text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-800/50"),
                  children: /* @__PURE__ */ jsx45("div", {
          ...
          isRootLevel && /* @__PURE__ */ jsx45("div", {
...
//# debugId=3BFC839ED6FB56EC64756E2164756E21
