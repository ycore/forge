...
function isAppError(value) {
  ...
  if (obj.details !== void 0 && (typeof obj.details !== "object" || obj.details === null)) {
    return false;
  }
  if (obj.code !== void 0 && typeof obj.code !== "string") {
    return false;
  }
  if (obj.status !== void 0 && typeof obj.status !== "number") {
    return false;
  }
  const allowedErrorProperties = /* @__PURE__ */ new Set(["message", "details", "cause", "code", "status"]);
...
function getData(result) {
  return isError(result) ? void 0 : result;
}
function getError(result) {
  return isError(result) ? result : void 0;
}
...
async function tryCatch(fn, errorMessage) {
  try {
    ...
    return err(errorMessage || "Operation failed", void 0, { cause: error });
  }
}
...
function toAppError(error) {
  ...
  if (error instanceof Error) {
    return err(error.message, void 0, { cause: error });
  }
...
function unauthorizedError(message = "Unauthorized") {
  return err(message, void 0, { code: "UNAUTHORIZED", status: 401 });
}
function forbiddenError(message = "Forbidden") {
  return err(message, void 0, { code: "FORBIDDEN", status: 403 });
}
...
function serverError(message = "Internal server error", cause) {
  return err(message, void 0, { cause, code: "INTERNAL_ERROR", status: 500 });
}
...
function serviceUnavailableError(message = "Service temporarily unavailable", cause) {
  return err(message, void 0, { cause, code: "SERVICE_UNAVAILABLE", status: 503 });
}
